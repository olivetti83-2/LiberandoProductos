...
AGUR_ENDPOINT_REQUESTS = Counter('agur_requests_total', 'Total number of requests to agur endpoint')
...
class SimpleServer:
    ...
    async def read_main():
        ...
        # Increment counter used for register the total number of calls in the webserver
        REQUESTS.inc()
        # Increment counter used for register the total number of calls to the main endpoint
